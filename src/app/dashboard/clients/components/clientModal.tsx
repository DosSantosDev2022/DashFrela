  ...
  return (
    <>
      <div className="flex items-center justify-between p-6 border">
        ...
        <Dialog.Root>
          <Dialog.Trigger className="bg-MyColor01 text-white p-2 rounded-md hover:bg-MyColor02">
            Cadastrar cliente
          </Dialog.Trigger>
          <Dialog.Portal>
            ...
            <Dialog.Content className="fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-md shadow-md bg-white p-8 w-[804px] ">
              <header className="flex  items-center justify-between  mb-3">
                <div className="flex flex-col items-start">
                  <h2 className="text-MyColor01 font-bold text-lg">
                    Cadastrar novo cliente
                  </h2>
                  <p className="text-MyColor02 font-light text-md">
              ...
              <main>
                <h4 className="text-MyColor01 font-semibold text-lg mb-4 border-b">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="flex gap-5 items-center justify-center mt-5 w-full ">
                      <div className="flex flex-col gap-2 w-full">
                        ...
                        {loading ? (
                          <p className="text-xs font-normal text-MyColor01">
                            Buscando cidades...
                          </p>
                        ) : (
