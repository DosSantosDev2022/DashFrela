    ...
    <nav>
      <ul className="flex flex-col gap-6 h-full">
        {links.map((link) => (
          <li
            key={link.nome}
            className="text-secondary-foreground-foreground list-none flex items-center gap-2 p-1 cursor-pointer hover:bg-slate-100 hover:text-zinc-900 transition-all hover:scale-105 rounded-md "
          >
            <i>{link.icon}</i>
