...
const SelectItem = (({ children, ...props } : SelectItemProps ) => {
  return (
    <Select.Item  className={('text-lg leading-none text-MyColor01 rounded-[3px] flex items-center h-[25px] pr-[35px] pl-[25px] relative select-none data-[disabled]:text-mauve8 data-[disabled]:pointer-events-none data-[highlighted]:outline-none data-[highlighted]:bg-MyColor04 data-[highlighted]:text-MyColor02')} {...props}>
